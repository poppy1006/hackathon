...
import 'package:veel/card_details.dart';
           ...
           child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children:const [
                    Text("Hi,",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w500),),
                    Text("John Doe",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w800),),
                    Divider()
                  ]
              ...
              SizedBox(height: 10,),
                ...
                Row(
                  ...
                  InkWell(
                    onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => CardDetails()));},
                    child: 
                  Card(
